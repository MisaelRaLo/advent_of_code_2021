defmodule DayOne do
  ...
  @spec perform_part_one(binary) :: integer
  def perform_part_one(input) do
    input
    |> parse_input()
    # -1 for initial value
  ...
  @spec perform_part_two(binary) :: integer
  def perform_part_two(input) do
    input
    |> parse_input()
    |> group_measurements([])
    # -1 for initial value
  ...
  @spec group_measurements(list, list) :: list
  ...
  # When is over, return the final list of tuples
